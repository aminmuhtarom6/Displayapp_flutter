    ...
    return Obx(
      () => Scaffold(
        ...
        appBar: AppBar(
          ...
          title: boldText(text: "${widget.data['p_name']}", size: 16.0, color: white),
          actions: [
            controller.isLoading.value
                ...
                : CupertinoButton(
                    ...
                    onPressed: () async {
                      ...
                      await controller.updateProduct(widget.data.id);
                      // ignore: use_build_context_synchronously
                      Get.back();
                    },
                    child: const Icon(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                10.heightBox,
                customTextField(
                    hint: "${widget.data['p_name']}",
                    label: "Nama Produk",
                    controller: controller.pnameController),
                10.heightBox,
                customTextField(
                    hint: "${widget.data['p_price']}",
                    label: "Harga Produk",
                    controller: controller.ppriceController),
                10.heightBox,
                customTextField(
                    hint: "${widget.data['p_qty']}",
                    label: "Kuantiti Produk",
                    controller: controller.pqtyController),
                10.heightBox,
                customTextField(
                    hint: "${widget.data['p_variant'][0]}",
                    label: "Varian Produk",
                    controller: controller.pVariantController),
                10.heightBox,
                customTextField(
                    hint: "${widget.data['p_description']}",
